...
const chapters = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: "Vente vs autres contrats translatifs",
        content: [
          { type: "comparison", rows: [
            { label: "Vente vs Donation", a: "À titre onéreux (prix)", b: "À titre gratuit (animus donandi)" },
            { label: "Vente vs Échange", a: "Contrepartie monétaire (prix)", b: "Transfert réciproque de choses (art. 1702)" },
            { label: "Vente vs Apport en société", a: "Contrepartie = prix", b: "Contrepartie = droits sociaux" },
            { label: "Vente vs Dation en paiement", a: "Cause = paiement d'un prix", b: "Cause = extinction d'une dette" },
          ]},
          { type: "info", label: "Échange & lésion", text: "Seule différence avec la vente : la rescision pour lésion immobilière (art. 1674) ne s'applique PAS à l'échange (art. 1706). Sinon toutes les règles de la vente s'appliquent (art. 1707)." }
        ]
      },
      {
